...
export function MeterFace({
  ...
  return (
    <svg viewBox="0 0 440 260" width="100%" style={{ maxWidth: 460, display: "block", margin: "0 auto" }}>
      <defs>
      ...
      {/* Vỏ đồng hồ */}
      <rect x="6" y="6" width="428" height="248" rx="18" fill="url(#meterBezel)" stroke="#4a5566" strokeWidth="1.5" />
      {[[24, 24], [416, 24], [24, 236], [416, 236]].map(([cx, cy]) => (
      ...
      {/* Đáy đồng hồ */}
      <text x="220" y="200" textAnchor="middle" fill="#aab4c2" fontSize="13" fontWeight="600">
        {label}
      </text>
      <rect x="24" y="212" width="392" height="2" fill="#2a323d" />
      <text x="220" y="232" textAnchor="middle" fill="#6b7585" fontSize="10" letterSpacing="2">
